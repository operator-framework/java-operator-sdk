...
@ControllerConfiguration(
    ...
    labelSelector = WebPageReconcilerLowLevel.LOW_LEVEL_LABEL_KEY)
public class WebPageReconcilerLowLevel
  ...
  public WebPageReconcilerLowLevel(KubernetesClient kubernetesClient) {
