...
//   1.1. Finalizer: how to override based on the type of resources present -> if non k8s needs finalizer
// 2. resources without cache?

public class DependentResourceReconciler<T extends HasMetadata> implements Reconciler<T>, EventSourceInitializer<T>,
