...
class KubernetesDependentResourceTest {
    ...
    public void setup() {
        ...
        when(informerConfigurationMock.getAssociatedResourceIdentifier()).thenReturn(associatedResourceIdentifierMock);
    ...
    void getResourceCheckTheTemporalCacheFirst() {
        when(temporalResourceCacheMock.getResourceFromCache(any())).thenReturn(Optional.of(testResource()));
