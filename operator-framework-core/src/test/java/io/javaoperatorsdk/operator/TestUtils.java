...
public class TestUtils {
  ...
  public static TestCustomResource testCustomResource() {
    return testCustomResource(new ObjectKey(UUID.randomUUID().toString(), "test"));
  }
  ...
  public static TestCustomResource testCustomResource1() {
    return testCustomResource(new ObjectKey("test1", "default"));
  }

  public static TestCustomResource testCustomResource(ObjectKey id) {
