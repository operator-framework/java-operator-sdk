...
public abstract class PollingDependentResource<R, P extends HasMetadata>
  ...
  private final IDProvider<R> idProvider;

  public PollingDependentResource(Class<R> resourceType, IDProvider<R> idProvider) {
    super(resourceType);
    this.idProvider = idProvider;
  }

  public PollingDependentResource(Class<R> resourceType, long pollingPeriod, IDProvider<R> idProvider) {
  ...
  public Optional<R> fetchResource(P primaryResource) {
    return (PollingEventSource<R,P>)eventSource().;
  }
}
