...
public class CustomResourceEventSource<T extends CustomResource<?, ?>> extends AbstractEventSource
  ...
  public void eventReceived(Watcher.Action action, T customResource) {
    ...
    if (oldResource == null || customResource.isMarkedForDeletion()) {
      ...
      if (controller.getConfiguration().useFinalizer()) {
        boolean oldFinalizer =
            oldResource.hasFinalizer(controller.getConfiguration().getFinalizer());
        boolean newFinalizer =
            customResource.hasFinalizer(controller.getConfiguration().getFinalizer());

        fire = !oldFinalizer || !newFinalizer;
      }
