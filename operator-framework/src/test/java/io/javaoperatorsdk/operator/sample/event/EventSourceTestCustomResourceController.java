...
@Controller(
        crdName = EventSourceTestCustomResourceController.CRD_NAME)
public class EventSourceTestCustomResourceController implements ResourceController<EventSourceTestCustomResource>,
    ...
    private static final Logger log = LoggerFactory.getLogger(EventSourceTestCustomResourceController.class);
