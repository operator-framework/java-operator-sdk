...
@ControllerConfiguration(
    onUpdateFilterCombinedWithOr = true,
    informer = @Informer(onUpdateFilter = OrCombinedUpdateFilter.class))
public class OrCombinedFilterTestReconciler implements Reconciler<FilterTestCustomResource> {
