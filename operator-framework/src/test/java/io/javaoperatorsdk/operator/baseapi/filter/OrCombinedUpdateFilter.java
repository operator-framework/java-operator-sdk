...
public class OrCombinedUpdateFilter implements OnUpdateFilter<FilterTestCustomResource> {
  ...
  public boolean accept(
    ...
    return annotations != null
        && "true".equals(annotations.get(OrCombinedFilterTestReconciler.TRIGGER_ANNOTATION));
  }
}
