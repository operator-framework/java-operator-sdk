...
class LeaderElectionPermissionIT {
  ...
  void operatorStopsIfNoLeaderElectionPermission() {
    ...
    var operator = new Operator(o -> {
      ...
      o.withLeaderElectionConfiguration(new LeaderElectionConfiguration("lease1", "default"));
  ...
  private void applyRoleBinding() {
    var clusterRoleBinding = ReconcilerUtils.loadYaml(RoleBinding.class, this.getClass(),
  ...
  private void applyRole() {
    var role = ReconcilerUtils.loadYaml(Role.class, this.getClass(),
        "leader-elector-stop-role-noaccess.yaml");
