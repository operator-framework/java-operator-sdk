...
public class PrimaryIndexerTestReconciler extends AbstractPrimaryIndexerTestReconciler {
  ...
  public List<EventSource<?, PrimaryIndexerTestCustomResource>> prepareEventSources(
    ...
    var informerConfiguration = InformerEventSourceConfiguration
        ...
        .withSecondaryToPrimaryMapper((ConfigMap secondaryResource) -> context.getPrimaryCache()
            .byIndex(CONFIG_MAP_RELATION_INDEXER, secondaryResource.getMetadata().getName())
