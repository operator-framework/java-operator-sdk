...
class DefaultEventSourceManagerTest {
    ...
    public void deRegistersEventSources() {
        ...
        defaultEventSourceManager.deRegisterCustomResourceFromEventSource(CUSTOM_EVENT_SOURCE_NAME, getUID(customResource));

        verify(eventSource, times(1)).eventSourceDeRegisteredForResource(eq(KubernetesResourceUtils.getUID(customResource)));
    }
